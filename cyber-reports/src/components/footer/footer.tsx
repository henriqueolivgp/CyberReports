    ...
    <footer className=" bg-footer-bg dark:bg-slate-900">
      ...
      <form className="flex justify-center">
        <div className="relative w-72">
          ...
          <input
            type="text"
            className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className=" w-full">
        ...
        <div className="px-4 py-6 bg-footer-bg  text-center ">
          ...
          <div className="flex mt-4 space-x-6 justify-center md:mt-0 ml-4">
            ...
            <a
              href="https://github.com/henriqueolivgp/Plataforma-De-Denuncias-De-Ciberataques"
              target="_blank"
              className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
            >
              <svg
          ...
          <span className="text-sm text-gray-500 dark:text-gray-300 text-center">
            © 2023 <a href="https://flowbite.com/">Cyber Reports</a>. All Rights
            Reserved.
          </span>
        </div>
      </div>
