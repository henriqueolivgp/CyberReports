    ...
    <div className="flex justify-end">
      <div className="flex justify-center items-center mr-2">
        <button
          ...
          className="top-0 right-0 mb-2 inline-flex items-center p-2 text-sm font-medium text-center bg-slate-800 rounded-lg hover:bg-slate-600 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-slate-800 dark:hover:bg-slate-950 dark:focus:ring-gray-600"
          type="button"
      ...
      {isOpen && (
        <div
          ...
          ref={dropdownRef}
          className={`mt-10 overflow-auto custom-scrollbar drop-shadow-xl absolute max-h-96 top-50% -left ${
            isOpen ? "" : "hidden"
        ...
        >
          ...
          >
            <li className=" hover:bg-slate-600 py-1 border-b border-slate-500">
              <a
                href="#"
                ...
                className={`inline-block p-4 ${
                  filterType === "All "
                    ...
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
                All Reports
              </a>
            </li>
            <li className=" hover:bg-slate-600 py-1">
              <a
                href="#"
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                href="#"
                onClick={() =>
                  setFilterType("Ataques de Negação de Serviço DoS/DDoS")
                } // Atualizar o estado do filtro
                className={`inline-block p-4 ${
                  filterType === "Ataques de Negação de Serviço DoS/DDoS"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                ...
                className={`inline-block p-4 ${
                  filterType === "Intrusões em Sistemas"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                ...
                className={`inline-block p-4 ${
                  filterType === "Violência ou Conteúdo Ilícito"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                ...
                className={`inline-block p-4 ${
                  filterType === "Exploração de Vulnerabilidades"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                ...
                className={`inline-block p-4 ${
                  filterType === "Incidentes em Redes Sociais"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                href="#"
                onClick={() =>
                  setFilterType("Incidentes em Dispositivos Conectados IoT")
                } // Atualizar o estado do filtro
                className={`inline-block p-4 ${
                  filterType === "Incidentes em Dispositivos Conectados IoT"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
            ...
            <li className=" hover:bg-slate-600 py-1">
              <a
                ...
                className={`inline-block p-4 ${
                  filterType === "Spam e Phishing por SMS"
                    ? "text-bluelite border-b-2 border-bluelite rounded-t-lg active dark:text-blue-500 dark:border-blue-500"
                    : "block px-4 py-2 hover:bg-slate-600 dark:hover:bg-gray-600 dark:hover:text-white"
                }`}
              >
